        ...
        <div className="container">
          ...
          <div className="flex flex-col gap-6 items-center mt-10 lg:flex-row lg:items-end justify-center">
            {pricingTiers.map(({title, monthlyPrice, buttonText, popular, inverse, features}) => (
              <div key={title} className={twMerge("p-10 border border-solid border-[#222222]/10 rounded-3xl shadow-[0_7px_14px_#eaeaea] max-w-xs w-full", inverse === true && 'border-black bg-black text-white')}>
